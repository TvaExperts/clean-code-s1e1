...
var taskInput=document.querySelector('.add-tasks__input-new-task');//Add a new task.
var addButton=document.querySelectorAll('.btn')[0];//first button
var incompleteTaskHolder=document.querySelector('.task-list--uncomplited');//ul of #incompleteTasks
var completedTasksHolder=document.querySelector('.task-list--complited');//completed-tasks
...
var createNewTaskElement=function(taskString){
  ...
  var label=document.createElement('label');//label3
